...
- Inclui um Studio de treinamento opcional. O chat continua separado do treino:
  o Studio baixa dependências somente quando solicitado, prepara os dados localmente
  e publica o GGUF na biblioteca do app.
