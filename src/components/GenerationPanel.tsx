// Painel global de trabalho em andamento: streams de geração. Visível
// enquanto houver job vivo. A UI só observa, cancela e leva de volta à
// conversa — o store é que é o keep-alive.
